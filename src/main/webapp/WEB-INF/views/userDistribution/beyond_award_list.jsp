...
<script type="text/javascript" src="${ctx}/js/userDistribution/beyond_award_list.js"></script>

</head>
<body>
	<!-- 操作栏 -->
	<form id="userDistribution-search-form" method="post" class="am-form am-form-horizontal">
	...
	<!-- 数据表格 -->
	<table id="userDistribution-datagrid" style="min-height: 400px; height: auto; width: 100%;"></table>
</body>
</html>
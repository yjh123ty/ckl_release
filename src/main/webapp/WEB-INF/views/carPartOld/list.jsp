...
<script type="text/javascript" src="${ctx}/js/carPartOld/list.js"></script>

</head>
<body>
	<!-- 操作栏 -->
	<form id="carPartOld-search-form" method="post" class="am-form">
	...
	<!-- 数据表格 -->
	<table id="carPartOld-datagrid" style="min-height: 400px; height: auto; width: 100%;"></table>
</body>
</html>
...
<script type="text/javascript" src="${ctx}/js/jobTitle/jobTitle.js"></script>

</head>
<div class="am-g" style='margin: 1px; padding: 10px'>
		<a class="am-btn am-btn-default am-btn-xs" style="border-radius: 300px;" href="${ctx}/employee/index.do">员工账号</a>
		&emsp;
		<a class="am-btn am-btn-success am-btn-xs" style="border-radius: 300px;" href="${ctx}/jobTitle/index.do">设定岗位</a>
</div>
	<hr>
<body>
<div id="content" style='margin: 10px; padding: 10px'>
	<!-- 操作栏 -->
<!-- 	<div class="am-g"> -->
<%-- 		<a href="${ctx}/jobTitle/index.do?cmd=save"  --%>
<!-- 			class="am-btn am-btn-success am-btn-xs" style="border-radius: 300px;" role="button">添加岗位</a> -->
<!-- 	</div> -->

	<!-- 职称查询栏 -->
	<form id="jobTitle-search-form" method="post">
		...
		<div class="am-g am-margin">
			...
			<div class="am-u-sm-5 am-u-end">
				<input name="keywords" type="text" class="am-form-field" placeholder="职位名称">
			</div>
		</div>	
	</form>
	...
	<!-- 数据表格 -->
	<table id="jobTitle-datagrid" style="height: auto; min-height:400px; width: 100%;"></table>
</div>
	...
	var searchForm = $('#jobTitle-search-form');
	var datagrid = $("#jobTitle-datagrid");

...
<script type="text/javascript" src="${ctx}/js/restaurant/restaurant_manager.js"></script>
</head>
<body>
	<!-- 饭店工具条 -->
	<div class="am-g am-margin-left" style="padding: 8px;">
		<div class="am-g">
			<div class="am-u-sm-3">
				<a href="${ctx}/restaurant/index.do?cmd=save"
					class="am-btn am-btn-success am-btn-xs"
					style="border-radius: 300px;">添&nbsp;加</a>
			</div>
		</div>
		<form id="restaurant-search-form" class="am-form">
			<div class="am-g am-margin-top">
				...
				<div class="am-u-sm-6 am-u-md-5 am-u-lg-4 am-u-end">
					<div class="am-input-group">
						<input name="keyword" type="text" class="am-form-field" placeholder="请输入饭店名称">
		...
		<div class="am-g am-margin">
			<div class="am-u-sm-1"
						style="text-align: center;">饭店星级：</div>
	...
	<!-- 饭店表格 -->
	<table id="restaurant-datagrid" style="width: 100%;height: auto; min-height: 400px;">
	</table>
	<script type="text/javascript">
	var restaurantDatagrid = $("#restaurant-datagrid");
		function changeStatus(id,status){
			$.post(_ctx+"/restaurant/changeStatus.do",{id:id,status:status},function(data){
				if(data && data.success) {
					restaurantDatagrid.datagrid("reload");
				}
			}, "json");
		}
	</script>

...
<script type="text/javascript" src="${ctx}/js/salary/salaryInflationRate.js"></script>
...
<div class="am-g" style='margin: 1px; padding: 10px'>
			...
			&nbsp;
			<a class="am-btn am-btn-success am-btn-xs" style="border-radius: 300px;" href="${ctx}/salaryInflationRate/index.do">薪点值</a>
			&nbsp;
...
<hr>
  ...
  <div id="content" style='margin: 10px; padding: 10px'>
	...
	<div class="am-g" style='margin: 10px'>
		<a href="${ctx}/salaryInflationRate/index.do?cmd=save" 
			class="am-btn am-btn-success am-btn-xs" style="border-radius: 300px;" role="button">添加薪点值</a>
	</div>
	
	<!-- 数据表格 -->
	<table id="salaryInflationRate-datagrid" style="height: auto; min-height:400px; width: 100%;"></table>
  </div>

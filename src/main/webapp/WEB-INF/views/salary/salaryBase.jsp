...
<script type="text/javascript" src="${ctx}/js/salary/salaryBase.js"></script>
...
<div class="am-g" style='margin: 1px; padding: 10px'>
			...
			&nbsp;
			<a class="am-btn am-btn-success am-btn-xs" style="border-radius: 300px;" href="${ctx}/salaryBase/index.do">基本工资标准</a>
			&nbsp;
...
<hr>
  ...
  <div id="content" style='margin: 10px; padding: 10px'>
	<table id="salaryBase-datagrid" style="height: auto; min-height:400px; width: 100%;"></table>
  </div>

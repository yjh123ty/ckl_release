...
<script type="text/javascript" src="${ctx}/js/userBill/userBillRecharge.js"></script>

</head>
<body>
<div id="content" style='margin: 10px; padding: 10px'>
	<form id="userBillRecharge-search-form" method="post">
	...
	<!-- 数据表格 -->
	<table id="userBillRecharge-datagrid" style="height: auto; min-height:400px; width: 100%;">
	</table>
</div>
	...
	<script language="javascript">
		...
		function Searching(){
		 ...
		 var datagrid = $("#userBillRecharge-datagrid");
		 var searchForm =  $("#userBillRecharge-search-form");

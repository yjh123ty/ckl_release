...
<script type="text/javascript" src="${ctx}/js/carPartStockOutcome/station_edit.js"></script>
		...
		<form id="form-edit" class="am-form am-form-horizontal" enctype="multipart/form-data" method="post">
			...
			<div class="am-form-group">
				<div class="am-u-sm-10 am-u-sm-offset-2">
					...
					<a class="am-btn am-btn-success am-btn-sm" href="${ctx}/carPartStockOutcome/index.do?cmd=station">返回</a>
				</div>
			</div>

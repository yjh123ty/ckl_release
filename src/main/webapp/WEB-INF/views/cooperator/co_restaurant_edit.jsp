...
<title>合作商家饭店添加/修改</title>
</head>
<body class="am-g">
${restaurant}
	<div class="am-u-lg-10 am-u-md-12 am-margin-top">
		<form id="form-restaurant-edit" class="am-form am-form-horizontal" enctype="multipart/form-data" method="post">
			<input type="hidden" name="id" id="id" value="${restaurant.id}">
			<input type="hidden" name="type" value="2">
			<input type="hidden" name="fullAddress" id="fullAddress" value="${restaurant.fullAddress}">
			...
			<div class="am-form-group">
				...
				<div class="am-u-sm-9">
					<input name="name" type="text"  id="doc-ipt-3-a" class="am-form-field" placeholder="请输饭店名称" value="${restaurant.name}" required="required">
				</div>
			</div>
			...
			<div class="am-form-group">
				...
				<div class="am-u-sm-9">
					<input name="mobile" type="text"  id="doc-ipt-3-a" class="am-form-field" placeholder="请输入电话" value="${restaurant.mobile}" required="required">
				</div>
			</div>
			...
			<div class="am-form-group">
				...
				<div class="am-u-sm-9">
					<input name="address" type="text"  id="doc-ipt-3-a" class="am-form-field" placeholder="请输饭店详细地址" value="${restaurant.address}">
				</div>
			</div>
			...
			<div class="am-form-group am-form-file">
				...
				<div class="am-u-sm-4">
					...
					<input name="restaurant_cover_img" class="doc-form-file" type="file" accept="image/png,image/jpeg">
				</div>
				<div class="am-u-sm-5 am-u-end file-list"><font color="red">没有选择任何文件 &nbsp;*</font></div>
			</div>
			
			<div class="am-form-group am-form-file">
				<label for="doc-ipt-3-a" class="am-u-sm-3 am-form-label">饭店图片：</label>
				<div class="am-u-sm-4">
					<button type="button" class="am-btn am-btn-success am-btn-sm">
						<i class="am-icon-cloud-upload"></i> 选择要上传的文件
					</button>
					<input name="restaurant_imgs" class="doc-form-file" type="file" 
			...
			var btnClickObj = {
				'restaurant-confirm':function(){
					...
					restaurantEditForm.ajaxSubmit( {    
			    	       url:       _ctx+"/cooperatorRestaurant/edit.do", 
			    	       type:      "post",
			    	       data:data,
			    	       clearForm: false,     
			    	       resetForm: false,     
			    	       ...
			    	       success: function(data){
			    	    	   if(isJsonObj(data)){
			    	    		   $.messager.alert("温馨提示", data.msg, "info",
		    							function() {
		    								//页面跳转
		    								location.href = _ctx + "/cooperatorRestaurant/index.do";
		    							});
								} else {
									$.messager.alert("温馨提示", data.msg, "info");
								}

...
<script type="text/javascript" src="${ctx}/js/cooperator/co_restaurant.js"></script>
</head>

<body>
<div class="am-g" style='margin: 1px; padding: 10px'>
	<a class="am-btn am-btn-default am-btn-xs" style="border-radius: 300px;width:100px;" href="${ctx}/cooperatorHotel/index.do">酒店</a>
	&emsp;
	<a class="am-btn am-btn-success am-btn-xs" style="border-radius: 300px;width:100px;" href="${ctx}/cooperatorRestaurant/index.do">饭店</a>
</div>
	<hr>
  ...
  <div id="content" style='margin: 10px; padding: 10px'>
	...
	<div class="am-g" style='margin: 10px; padding: 10px'>
		<a href="${ctx}/cooperatorRestaurant/index.do?cmd=save" class="am-btn am-btn-success am-btn-xs" style="border-radius: 300px;" role="button">添加商家</a>
	</div>
	<!-- 查询栏 -->
	<form id="cooperator-rest-search-form" method="post">
		...
		<div class="am-g am-margin">
			...
			<div class="am-u-sm-5 am-u-end">
				<input name="keywords" type="text" class="am-form-field" placeholder="饭店名称">
			</div>
		</div>	
	</form>
	...
	<!-- 数据表格 -->
	<table id="cooperator-rest-datagrid" style="height: auto; min-height:400px; width: 100%;"></table>
  </div>
	...
	var search = function(){
		...
		// 获取搜索表单 
		// 封装表单参数
		var paramObj = $('#cooperator-rest-search-form').serializeJson();
		// 发送post请求刷新 datagrid 的数据
		$('#cooperator-rest-datagrid').datagrid("load",paramObj);
	};
	...
	$(function() {
		...
		$("#resetSearchForm").on("click", function() {
			$('#cooperator-rest-search-form').form("clear");
		});
	})

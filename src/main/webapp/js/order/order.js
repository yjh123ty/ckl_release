	...
	orderGrid.datagrid(
			{
			    ...
			    columns:[[    
			        ...
			        {field:'station_id',title:'服务站点',width:80,align:'center',formatter:function(v,r,i){
			        	if(r.station){
...
//			    	$("a.sending").click(function(data){
//			    		var mobile = $(this).data('index');
//			    		$.messager.confirm("温馨提示", "是否发送短信？", function(yes) {
//			    			if (yes) {
//					    		$.post(_ctx + "/order/sendPayRemainMessage.do", {"mobile" : mobile}, 
//		    						function(data) {
//				    					// 判断
//				    					if (data.success) {
//				    						// 提示

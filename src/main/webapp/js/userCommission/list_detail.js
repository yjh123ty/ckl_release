...
$(function() {
	...
	userCommissionGrid.datagrid(
			{
				//请求地址
			    url:_ctx + "/userDistribution/listDetail.do",
			    //大小自适应
			    fit:false,
			    //无边框
			    border:false,
			    ...
			    columns:[[    
			        ...
			        {field:'rechargeUserMobile',title:'充值用户号',width:80,align:'center'},
			        {field:'rechargeUserNickName',title:'充值用户昵称',width:80,align:'center'},
			        {field:'type',title:'奖励类型',width:80,align:'center',formatter:function(v,r,i){
			        	if(v == 1){
			        		return "充值奖励";
			        	}
			        ...
			        {field:'amount',title:'佣金',width:80,align:'center'},
			        {field:'createTime',title:'发放时间',width:80,align:'center'},
			    ]]
			}
		);

...
$(function(){
	...
	// 公共变量
	// 获取列表数据的url
	var listUrl = _ctx + "/topic/listForumTopic.do";
	
	var deleteUrl = _ctx + "/topic/deleteForumTopic.do";
	
	var topUrl = _ctx + "/topic/topForumTopic.do";
	...
	topicDatagrid.datagrid(
		{
		    ...
		    columns:[[    
		        ...
		        {field:'null',title:'操作',width:10,align:'left',formatter:function(v,r,i){
		        	return "<a href='javascript:void(0);'  class='topic-delete' data-index='"+ i +"' style='color:red'>删除</a> <a href='javascript:void(0);'  class='topic-top' data-index='"+ i +"' style='color:yellow'>置顶</a>";
		        }}

...
$(function() {
	...
	// 列表url
	var listUrl = _ctx + "/templatetravelnote/list.do";
	
	var deleteUrl = _ctx + "/templatetravelnote/delete.do";

	// 添加、修改url
	var editUrl = _ctx + "/templatetravelnote/edit.do";
	...
	datagrid.datagrid({
		...
		},
		{
			...
			field : 'templateTravelNoteSuitNames',
			title : '适合人群',
			width : 10,
			align : 'center',
			...
			align : 'center',
			formatter:function(v,r,i){
				return '<a href="'+_ctx+'/templatetravelnote/view.do?id='+r.routeId+'">游记内容</button>';
			}
		}, {
			field : 'createTime',
			title : '录入时间',
